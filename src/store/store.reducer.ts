...
export const rootSlice = createSlice({
    ...
    reducers: {
        ...
        setEditingTask: (state: IState, action: PayloadAction<any>) => {
            state.editingTask.editingTask = action.payload;
        }
    },
});

export const {setLoader, toggleLeftMenu, setLocale, setUser, setEditingTask} = rootSlice.actions;
